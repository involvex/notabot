...
describe('yoloCommand', () => {
  ...
  describe('action', () => {
    ...
    it('should show enabled status when yolo mode is active', async () => {
      ...
      expect(result).toEqual({
        type: 'message',
        messageType: 'info',
        content: 'YOLO mode is currently enabled. All actions are automatically accepted without confirmation.\n\nTo change YOLO mode, restart notabot with:\n  notabot --yolo          # Enable YOLO mode\n  notabot --no-yolo       # Disable YOLO mode',
      });
    });
  ...
  describe('command properties', () => {
    it('should have correct name and description', () => {
      ...
      expect(yoloCommand.description).toBe('show YOLO mode status and instructions');
